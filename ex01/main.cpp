...
int main() {
    ...
    std::cout << "\n--- Testing Deep Copy for Dog and Cat with the copy constructor---" << std::endl;
    Dog originalDog;
    ...
    // 4. Test deep copy: copy a Dog and Cat, ensuring it's a deep copy
    std::cout << "--- Testing Deep Copy for Dog and Cat with the assignment operator---" << std::endl;
    Cat init;
	{
        std::cout << std::endl;
        std::cout << "inside small scope" << std::endl;
		Cat tmp;
		init = tmp;
        std::cout << std::endl; 
		tmp.makeSound();
    ...
    std::cout << std::endl;
	std::cout << "outside small scope" << std::endl;
	init.makeSound();
    std::cout << std::endl;
